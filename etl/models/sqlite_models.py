...
class FilmWork(SQLLiteDatabaseMixin):
    ...
    def map_to_postgre(self):
        ...
        return PostgreFilmWork(title=self.title,
...
class Person(SQLLiteDatabaseMixin):
    ...
    def map_to_postgre(self):
        return PostgrePerson(full_name=self.full_name,
                             id=self.id,
                             created=self.created_at,
                             modified=self.updated_at)
...
class Genre(SQLLiteDatabaseMixin):
    ...
    def map_to_postgre(self):
        new_description = self.description if self.description is not None else ''
        return PostgreGenre(name=self.name,
                            description=new_description,
                            id=self.id,
                            created=self.created_at,
                            modified=self.updated_at)
...
class GenreFilmWork:
    ...
    def map_to_postgre(self):
        return PostgreGenreFilmWork(film_work_id=self.film_work_id,
...
class PersonFilmWork:
    ...
    def map_to_postgre(self):
        return PostgrePersonFilmWork(film_work_id=self.film_work_id,
